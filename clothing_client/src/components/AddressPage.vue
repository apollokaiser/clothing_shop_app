        ...
        >
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="address-detail">
                ...
                >
                  ...
                  <option
                    v-for="province in city.province"
                ...
                >
                  ...
                  <option
                    v-for="district in city.district"
              ...
              <div class="location-detail">
                ...
                <div class="address-add-input">
                  <input v-model="addressName.addressDetail"
                    type="text"
                    class="form-control"
            ...
            <div class="modal-footer">
              ...
              <button @click.prevent="addAddress" data-bs-dismiss="modal" type="button" class="btn btn-primary">Thêm</button>
            </div>
          </div>
        </div>
      </div>
      <Transition name="fade">
        <div v-if="action.showMessage" class="notification">
          ...
          <div v-if="action.success" class="success">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path></svg>
            <span>{{ action.message }}</span>
            </div>
          <div v-else class="error">
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17"></path></svg>
            <span>{{ action.message }}</span>
          </div>
        </div>
      </Transition>
