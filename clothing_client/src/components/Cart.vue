...
const ticketCodeValue = computed(() => {
    return promotionCode.value.promotion.donVi == "PERCENT" ? promotionCode.value.promotion.giaTriGiam + "%" : shortCurrency(promotionCode.value.promotion.giaTriGiam);
})
...
<template>
    <div class="cart container mt-3">
            ...
            <div class="promotion-container">
                <div class="promotion-main">
                    <div class="promotion-header d-flex justify-content-between align-items-baseline">
                        <div>KHUYẾN MÃI</div>
                        <div data-bs-toggle="modal" data-bs-target="#prmotionCode">Nhập mã <i
                                class="fa fa-angle-double-right ms-1" aria-hidden="true"></i></div>
                    </div>
                    <div class="propmotion-content d-flex flex-column justify-content-center align-items-start">
                        ...
                        <PropmotionItem v-for="item in paymentPromotion" :key="item.maKhuyenMai" :promotion="item" :payment="true"></PropmotionItem>
                    </div>
                    <div class="promotion-apply">
                        <div class="promotion-apply-main">
                            <div v-if="promotionCode.check" class="promotion-card">
                                ...
                                <i @click="promotionCode.check = false" class="fa fa-times" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
                    <div class="promotion-footer d-flex justify-content-end align-items-baseline">
                ...
                <div class="payment-main">
                    ...
                    <div class="payment-footer d-flex justify-content-end align-items-baseline">
                        <button data-bs-toggle="modal" data-bs-target="#order"> Tính ngay
                            <span></span>
                        </button>
                    </div>
                </div>
        ...
        <!--add coupon modal-->
        <div class="modal fade" id="prmotionCode" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="prmotionCodeLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="modal-promotion-header">
                            <div class="modal-promotion-title">Có mã ưu đãi ? Nhập ngay nào !</div>
                            <div class="funny-img">
                    ...
                    <div class="modal-body">
                        <div class="promotion-code-container">
                            <div class="promotion-role">
                                <ul>
                                    <li>- Mã khuyến mãi được áp dụng mõi khách hàng duy nhất 1 lần</li>
                                    <li>- Khuyễn mãi chỉ áp dụng trong khoảng thời gian nhất định hoặc đến khi hết số
                                        lượng nhập</li>
                                </ul>
                            </div>
                            <div class="input-code">
                                ...
                                <div class="input-code-field">
                                    <input v-model="promotionCode.code" placeholder="Type here..." id="input-code"
                                        name="text" type="text">
                    ...
                    <div class="modal-footer">
                        ...
                        <button @click.prevent="confirmPromotionCode" data-bs-dismiss="modal" type="button"
