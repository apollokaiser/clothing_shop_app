          ...
          <div class="outfit-size">
            ...
            <div class="size">
              <label class="size-label" v-for="item in size" :key="item">
                <input
                  v-model="selectedSize[item].checked"
                  type="checkbox"
                  class="input-size"
                  :value="item"
                />
                ...
                <span>{{ item }}</span>
                <input
                  v-model="selectedSize[item].quantity"
                  class="quantity"
                  type="number"
...
const addOufitHandle =() =>{
  ...
  data.soLuong = notSize.value ? data.soLuong : size.map(item => item.soLuong).reduce((total, item) => total + item);
 size.forEach(item => {
    data.kichThuocs.push(item);
  })
  data.tenTrangPhuc = data.tenTrangPhuc.toLowerCase();
